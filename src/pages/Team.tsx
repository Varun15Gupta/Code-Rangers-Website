  ...
  const coreTeam = [
    {
      ...
      icon: (
        <a
          href="https://www.linkedin.com/in/punit-kumar/"
          target="_blank"
      ...
      <section className="relative py-20 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Meet the digital architects, problem solvers, and innovators who
            drive Code Rangers. Each member brings unique expertise, united to
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  <div className="relative mb-6">
                    <div className="w-24 h-24 mx-auto rounded-full overflow-hidden border-2 border-cyan-500/30 group-hover:border-cyan-500/60 transition">
                      <img
                        src={member.image}
                    ...
                    <div
                      className={`absolute -bottom-2 -right-2 w-8 h-8 bg-gradient-to-br ${member.gradient} rounded-full flex items-center justify-center border-2 border-black`}
                    >
                      {member.icon}
                    </div>
                  </div>

                  <h3 className="text-xl font-semibold text-white mb-1 group-hover:text-cyan-300 transition">
                    {member.name}
                  </h3>
                  <p className="text-cyan-400 font-medium text-sm font-mono">
                    {member.role}
                  </p>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="bg-gradient-to-br from-gray-900/50 to-black/50 rounded-3xl p-12 border border-cyan-500/20 backdrop-blur-sm">
            ...
            <p className="text-gray-300 mb-8 text-lg">
              ...
              tech enthusiasts to join our elite team. Bring your skills to the
              squad.
            </p>
            <a
